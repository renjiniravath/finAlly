...
class MassiveSource(MarketDataSource):
    """MarketDataSource backed by the Massive REST snapshot API. Used whenever MASSIVE_API_KEY
    is set. Polls on a fixed interval rather than streaming over a WebSocket, keeping this
    implementation symmetric with SimulatorSource (see MASSIVE_API.md §6)."""
