...
class SimulatorSource(MarketDataSource):
    """Default MarketDataSource: geometric Brownian motion with a market/sector/idiosyncratic
    factor model for correlated moves, plus occasional random event jumps."""
